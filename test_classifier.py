...
def main():
    ...
    #for fold_num in [1]:
        ...
        #source_dir = "/mnt/jag16a/data/1_ML_KBQC_TestData/PostProcess_2/Set_3" ## TODO: update path variable here ##
        ...
        #should only load for pretrained CNN
    ...
    mat_dir = "/mnt/jag16a/data/1_ML_KBQC_TestData/Results_1/Ksplit"        ## TODO: update path variable here ##
